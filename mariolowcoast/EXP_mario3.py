...
def Home():
    global game_over, test_mario, score, mario, car, pain, pos, run, Playscreen, ground, option, t, life
    ...
    if pygame.mouse.get_pressed()[0]: 
        if (pygame.mouse.get_pos()[0]>=420 and pygame.mouse.get_pos()[0]<=540) and (pygame.mouse.get_pos()[1]>=480 and pygame.mouse.get_pos()[1]<=530):
                            ...
                            #Playscreen=True 
                            #option = False 
                            score, life, mario,car,pain,pos,run,test_mario,Playscreen,ground,option,game_over,t=start() 
                            print('home ok')
